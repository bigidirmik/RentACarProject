...
namespace Business.Concrete // Secured Operation eklenmedi // [SecuredOperation("admin")]
{
    public class RentalManager : IRentalService
    {
        ...
        {
            //19. Gün Ödevi kapsamında backend üzerinde logic kuralı commend'lendi
        ...
        public IDataResult<List<RentalDetailDto>> GetRentalDetailsByRentalId(int rentalId)
        {
            ...
            return new SuccessDataResult<List<RentalDetailDto>>(_rentalDal.GetRentalDetailsByRentalId(rentalId), Messages.RentalsListed);
        }
        ...
        public IDataResult<List<RentalDetailDto>> GetRentalDetailsByCarId(int carId)
        {
            ...
            return new SuccessDataResult<List<RentalDetailDto>>(_rentalDal.GetRentalDetailsByCarId(carId), Messages.RentalsListed);
        }
        ...
        public IDataResult<List<RentalDetailDto>> GetRentalDetailsByCustomerId(int customerId)
        {
            ...
            return new SuccessDataResult<List<RentalDetailDto>>(_rentalDal.GetRentalDetailsByCustomerId(customerId), Messages.RentalsListed);
        }
    }
}