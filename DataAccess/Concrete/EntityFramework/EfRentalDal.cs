...
namespace DataAccess.Concrete.EntityFramework
{
    public class EfRentalDal : EfEntityRepositoryBase<Rental, RentACarContext>, IRentalDal
    {
        ...
        public List<RentalDetailDto> GetRentalDetailsByRentalId(int rentalId)
        {
            using (RentACarContext context = new RentACarContext())
            {
                var result = from rnt in context.Rentals.Where(rnt => rnt.Id == rentalId)
        ...
        public List<RentalDetailDto> GetRentalDetailsByCarId(int carId)
        {
            using (RentACarContext context = new RentACarContext())
            {
                var result = from rnt in context.Rentals.Where(rnt => rnt.CarId == carId)
        ...
        public List<RentalDetailDto> GetRentalDetailsByCustomerId(int customerId)
        {
            using (RentACarContext context = new RentACarContext())
            {
                var result = from rnt in context.Rentals.Where(rnt => rnt.CustomerId == customerId)
